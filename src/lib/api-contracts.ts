...
export const twitter6551RuntimeStatusSchema = z.object({
	...
	cloudAllFollowing: z.boolean().default(false),
	twillotCloudFallbackEnabled: z.boolean().default(false),
	twillotFallbackTimeoutMinutes: z.number().positive().default(30),
	twillotPendingCount: z.number().int().nonnegative().default(0),
	twillotCompletedCount: z.number().int().nonnegative().default(0),
	twillotFailedCount: z.number().int().nonnegative().default(0),
	targetTweetIds: z.array(z.string()),
	lastConnectedAt: z.string().nullable(),
	lastEventAt: z.string().nullable(),
	lastBackfillAt: z.string().nullable(),
	lastPaidFallbackAt: z.string().nullable().default(null),
	lastLocalHeartbeatAt: z.string().nullable(),
	localStaleSeconds: z.number(),
	localBridgeIngestedCount: z.number(),
	lastError: z.string().nullable(),
	reconnectCount: z.number(),
	ingestedCount: z.number(),
	fxConsecutiveTotalFailures: z.number().int().nonnegative().default(0),
	paidFallbackFailureThreshold: z.number().int().positive().default(3),
	paidFallbackCooldownMinutes: z.number().positive().default(360),
	paidBudgetDay: z.string().default(""),
	paidRequestsToday: z.number().int().nonnegative().default(0),
	paidDailyRequestBudget: z.number().int().nonnegative().default(24),
	paidRequestsRemaining: z.number().int().nonnegative().default(24),
});
	...
	providers: z.object({
		...
		twitter6551: z.object({
			...
			runtime: twitter6551RuntimeStatusSchema.default({
				...
				twillotFallbackTimeoutMinutes: 30,
