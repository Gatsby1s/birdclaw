...
The [changelog](https://github.com/Gatsby1s/birdclaw/blob/main/CHANGELOG.md) tracks what shipped recently. Goals and non-goals live in the [spec](spec.md). Released under the [MIT license](https://github.com/Gatsby1s/birdclaw/blob/main/LICENSE). Not affiliated with X Corp.
